...
def indeed():
    ...
    while(bool):
        ...
        print url
        page = html.fromstring(urllib2.urlopen(url).read())
        # Below code is to identify last page of resutls.
        link3 = page.xpath(".//div[contains(@class,'pagination')]/a[contains(@rel,'nofollow')]")
...
def glassdoor():
    ...
    while(more):
        ...
        # print "Finished grabbing page -- ",page_no, "duplicates ",duplicateCount, " jobs ",jobCount, " problems" ,problemCount
        page_no +=1
